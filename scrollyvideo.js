var ScrollyVideo = function() {
    "use strict";
    var t, e, i = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
        s = {
            exports: {}
        };
    t = s, e = s.exports,
        function(i, s) {
            var r = "function",
                ...
                V = function(t, e) {
                    for (var i, n, o, h, d, l, p = 0; p < e.length && !d;) {
                        ...
                        for (i = n = 0; i < f.length && !d;)
                            if (d = f[i++].exec(t))
                                for (o = 0; o < u.length; o++) l = d[++n], typeof(h = u[o]) === a && h.length > 0 ? 2 === h.length ? typeof h[1] == r ? this[h[0]] = h[1].call(this, l) : this[h[0]] = h[1] : 3 === h.length ? typeof h[1] !== r || h[1].exec && h[1].test ? this[h[0]] = l ? l.replace(h[1], h[2]) : s : this[h[0]] = l ? h[1].call(this, l, h[2]) : s : 4 === h.length && (this[h[0]] = l ? h[3].call(this, l.replace(h[1], h[2])) : s) : this[h] = l || s;
                        p += 2
                    }
                },
                Y = function(t, e) {
                ...
                W = function(t, e) {
                    if (typeof t === a && (e = t, t = s), !(this instanceof W)) return new W(t, e).getResult();
                    ...
                    return this.getBrowser = function() {
                        var t, e = {};
                        return e[d] = s, e[f] = s, V.call(e, r, c.browser), e.major = typeof(t = e.version) === o ? t.replace(/[^\d\.]/g, "").split(".")[0] : s, e
                    }, this.getCPU = function() {
                        var t = {};
                        return t[u] = s, V.call(t, r, c.cpu), t
                    }, this.getDevice = function() {
                        var t = {};
                        return t[p] = s, t[h] = s, t[l] = s, V.call(t, r, c.device), t
                        ...
                        return r = typeof t === o && t.length > 350 ? H(t, 350) : t, this
                    }, this.setUA(r), this
                };
            W.VERSION = "1.0.33", W.BROWSER = M([d, f, "major"]), W.CPU = M([u]), W.DEVICE = M([h, p, l, c, m, g, _, y, b]), W.ENGINE = W.OS = M([d, f]), t.exports && (e = t.exports = W), e.UAParser = W;
    ...
    var r = s.exports,
        n = {};
    ! function(t) {
        var e, i, s, r = (e = new Date, i = 4, s = {
            setLogLevel: function(t) {
                i = t == this.debug ? 1 : t == this.info ? 2 : t == this.warn ? 3 : (this.error, 4)
            },
            debug: function(t, s) {
                void 0 === console.debug && (console.debug = console.log), 1 >= i && console.debug("[" + r.getDurationString(new Date - e, 1e3) + "]", "[" + t + "]", s)
            },
            log: function(t, e) {
                this.debug(t.msg)
            },
        ...
        r.getDurationString = function(t, e) {
            ...
            var a = Math.floor(r / 60),
                o = 1e3 * (r -= 60 * a);
            return o -= 1e3 * (r = Math.floor(r)), o = Math.floor(o), (i ? "-" : "") + n + ":" + s(a, 2) + ":" + s(r, 2) + "." + s(o, 3)
        ...
        a.prototype.readInt64 = function() {
            ...
            var r = null,
                n = "ASCII",
                o = this.position;
            switch ("string" == typeof t && /:/.test(t) && (s = t.split(":"), t = s[0], r = parseInt(s[1])), "string" == typeof t && /,/.test(t) && (s = t.split(","), t = s[0], n = parseInt(s[1])), t) {
                case "uint8":
                    this.writeUint8(e);
                    break;
                case "int8":
        ...
        (h.prototype = new a(new ArrayBuffer, 0, a.BIG_ENDIAN)).initialized = function() {
            ...
            var e, i, s, n, a, o = [],
                h = "";
            for (s = 0, n = 0, e = 0; e < this.buffers.length; e++) i = this.buffers[e], 0 === e ? (a = {}, o.push(a), a.start = i.fileStart, a.end = i.fileStart + i.byteLength, h += "[" + a.start + "-") : a.end === i.fileStart ? a.end = i.fileStart + i.byteLength : ((a = {}).start = i.fileStart, h += o[o.length - 1].end - 1 + "], [" + a.start + "-", a.end = i.fileStart + i.byteLength, o.push(a)), s += i.usedBytes, n += i.byteLength;
            ...
            return -1 !== a && (n = this.buffers[a]).fileStart + n.byteLength >= e ? (r.debug("MultiBufferStream", "Found position in existing buffer #" + a), a) : -1
        ...
        var d = function() {
            ...
            return this.parseOneDescriptor = function(e) {
                var s, n, a, o = 0;
                for (s = e.readUint8(), a = e.readUint8(); 128 & a;) o = (127 & a) << 7, a = e.readUint8();
                return o += 127 & a, r.debug("MPEG4DescriptorParser", "Found " + (t[s] || "Descriptor " + s) + ", size " + o + " at position " + e.getPosition()), (n = t[s] ? new i[t[s]](o) : new i.Descriptor(o)).parse(e), n
        ...
        var l = {
            ...
            createSampleEntryCtor: function(t, e, i, s) {
                l.sampleEntryCodes[t].push(e), l[e + "SampleEntry"] = function(i) {
                    l[t + "SampleEntry"].call(this, e, i), l.addSubBoxArrays.call(this, s)
                }, l[e + "SampleEntry"].prototype = new l[t + "SampleEntry"], i && (l[e + "SampleEntry"].prototype.parse = i)
            },
            ...
            createUUIDBox: function(t, e, i, s) {
                l.UUIDs.push(t), l.UUIDBoxes[t] = function(s) {
                    e ? l.FullBox.call(this, "uuid", s, t) : i ? l.ContainerBox.call(this, "uuid", s, t) : l.Box.call(this, "uuid", s, t)
                }, l.UUIDBoxes[t].prototype = e ? new l.FullBox : i ? new l.ContainerBox : new l.Box, s && (l.UUIDBoxes[t].prototype.parse = e ? function(t) {
        ...
        l.initialize(), l.TKHD_FLAG_ENABLED = 1, l.TKHD_FLAG_IN_MOVIE = 2, l.TKHD_FLAG_IN_PREVIEW = 4, l.TFHD_FLAG_BASE_DATA_OFFSET = 1, l.TFHD_FLAG_SAMPLE_DESC = 2, l.TFHD_FLAG_SAMPLE_DUR = 8, l.TFHD_FLAG_SAMPLE_SIZE = 16, l.TFHD_FLAG_SAMPLE_FLAGS = 32, l.TFHD_FLAG_DUR_EMPTY = 65536, l.TFHD_FLAG_DEFAULT_BASE_IS_MOOF = 131072, l.TRUN_FLAGS_DATA_OFFSET = 1, l.TRUN_FLAGS_FIRST_FLAG = 4, l.TRUN_FLAGS_DURATION = 256, l.TRUN_FLAGS_SIZE = 512, l.TRUN_FLAGS_FLAGS = 1024, l.TRUN_FLAGS_CTS_OFFSET = 2048, l.Box.prototype.add = function(t) {
        ...
        }, t.BoxParser = l, l.parseUUID = function(t) {
            ...
            var d = t.readUint32(),
                p = t.readString(4),
                f = p;
            if (r.debug("BoxParser", "Found box of type '" + p + "' and size " + d + " at position " + o), h = 8, "uuid" == p) {
            ...
            if (1 == d) {
                if (t.getEndPosition() - t.getPosition() < 8 || i && i - h < 8) return t.seek(o), r.warn("BoxParser", 'Not enough data in stream to parse the extended size of the "' + p + '" box'), {
                    code: l.ERR_NOT_ENOUGH_DATA
                };
                d = t.readUint64(), h += 8
            } else if (0 === d)
                if (i) d = i;
                else if ("mdat" !== p) return r.error("BoxParser", "Unlimited box size not supported for type: '" + p + "'"), s = new l.Box(p, d), {
                code: l.OK,
                box: s,
                size: s.size
            };
            return d < h ? (r.error("BoxParser", "Box of type " + p + " has an invalid size " + d + " (too small to be a box)"), {
                ...
                hdr_size: h,
                start: o
            }) : o + d > t.getEndPosition() ? (t.seek(o), r.info("BoxParser", "Not enough data in stream to parse the entire '" + p + "' box"), {
                code: l.ERR_NOT_ENOUGH_DATA,
                type: p,
                size: d,
                hdr_size: h,
                ...
                hdr_size: h,
                start: o
            } : (l[p + "Box"] ? s = new l[p + "Box"](d) : "uuid" !== p ? (r.warn("BoxParser", "Unknown box type: '" + p + "'"), (s = new l.Box(p, d)).has_unparsed_data = !0) : l.UUIDBoxes[a] ? s = new l.UUIDBoxes[a](d) : (r.warn("BoxParser", "Unknown uuid type: '" + a + "'"), (s = new l.Box(p, d)).uuid = a, s.has_unparsed_data = !0), s.hdr_size = h, s.start = o, s.write === l.Box.prototype.write && "mdat" !== s.type && (r.info("BoxParser", "'" + f + "' box writing not yet implemented, keeping unparsed data in memory for later write"), s.parseDataAndRewind(t)), s.parse(t), (n = t.getPosition() - (s.start + s.size)) < 0 ? (r.warn("BoxParser", "Parsing of box '" + f + "' did not read the entire indicated box data size (missing " + -n + " bytes), seeking forward"), t.seek(s.start + s.size)) : n > 0 && (r.error("BoxParser", "Parsing of box '" + f + "' read " + n + " more bytes than the indicated box data size, seeking backwards"), t.seek(s.start + s.size)), {
                code: l.OK,
                box: s,
                size: s.size
            })
            ...
            if (0 !== this.version && 1 !== this.version || (this.item_ID = t.readUint16(), this.item_protection_index = t.readUint16(), this.item_name = t.readCString(), this.content_type = t.readCString(), this.content_encoding = t.readCString()), 1 === this.version) return this.extension_type = t.readString(4), r.warn("BoxParser", "Cannot parse extension type"), void t.seek(this.start + this.size);
            ...
            for (this.references = []; t.getPosition() < this.start + this.size;) {
                ...
                (i = 0 === this.version ? new l.SingleItemTypeReferenceBox(e.type, e.size, e.hdr_size, e.start) : new l.SingleItemTypeReferenceBoxLarge(e.type, e.size, e.hdr_size, e.start)).write === l.Box.prototype.write && "mdat" !== i.type && (r.warn("BoxParser", i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), i.parseDataAndRewind(t)), i.parse(t), this.references.push(i)
            }
            ...
            for (var e = t.readUint32(), i = 0; i < e; i++) {
                var s;
                s = l[this.grouping_type + "SampleGroupEntry"] ? new l[this.grouping_type + "SampleGroupEntry"](this.grouping_type) : new l.SampleGroupEntry(this.grouping_type), this.entries.push(s), 1 === this.version && 0 === this.default_length ? s.description_length = t.readUint32() : s.description_length = this.default_length, s.write === l.SampleGroupEntry.prototype.write && (r.info("BoxParser", "SampleGroup for type " + this.grouping_type + " writing not yet implemented, keeping unparsed data in memory for later write"), s.data = t.readUint8Array(s.description_length), t.position -= s.description_length), s.parse(t)
            }
            ...
            for (var e = t.readUint16(), i = 0; i < e; i++) {
                ...
                var r = t.readUint32();
                s.reference_type = r >> 31 & 1, s.referenced_size = 2147483647 & r, s.subsegment_duration = t.readUint32(), r = t.readUint32(), s.starts_with_SAP = r >> 31 & 1, s.SAP_type = r >> 28 & 7, s.SAP_delta_time = 268435455 & r
            }
            ...
            for (this.entries = [], s = t.readUint32(), e = 1; e <= s; e++) {
                ...
                l[i.type + "SampleEntry"] ? ((n = new l[i.type + "SampleEntry"](i.size)).hdr_size = i.hdr_size, n.start = i.start) : (r.warn("BoxParser", "Unknown sample entry type: " + i.type), n = new l.SampleEntry(i.type, i.size, i.hdr_size, i.start)), n.write === l.SampleEntry.prototype.write && (r.info("BoxParser", "SampleEntry " + n.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), n.parseDataAndRewind(t)), n.parse(t), this.entries.push(n)
            }
        ...
        }, l.createTrackGroupCtor("msrc"), l.TrackReferenceTypeBox = function(t, e, i, s) {
            l.Box.call(this, t, e), this.hdr_size = i, this.start = s
            ...
            for (var e, i; t.getPosition() < this.start + this.size;) {
                if ((e = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK) return;
                (i = new l.TrackReferenceTypeBox(e.type, e.size, e.hdr_size, e.start)).write === l.Box.prototype.write && "mdat" !== i.type && (r.info("BoxParser", "TrackReference " + i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), i.parseDataAndRewind(t)), i.parse(t), this.boxes.push(i)
            }
        }, l.createFullBoxCtor("trep", (function(t) {
            for (this.track_ID = t.readUint32(), this.boxes = []; t.getPosition() < this.start + this.size;) {
                if (ret = l.parseOneBox(t, !1, this.size - (t.getPosition() - this.start)), ret.code !== l.OK) return;
            ...
            if (this.sample_count = t.readUint32(), e += 4, this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_DATA_OFFSET ? (this.data_offset = t.readInt32(), e += 4) : this.data_offset = 0, this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_FIRST_FLAG ? (this.first_sample_flags = t.readUint32(), e += 4) : this.first_sample_flags = 0, this.sample_duration = [], this.sample_size = [], this.sample_flags = [], this.sample_composition_time_offset = [], this.size - this.hdr_size > e)
                for (var i = 0; i < this.sample_count; i++) this.flags & l.TRUN_FLAGS_DURATION && (this.sample_duration[i] = t.readUint32()), this.flags & l.TRUN_FLAGS_SIZE && (this.sample_size[i] = t.readUint32()), this.flags & l.TRUN_FLAGS_FLAGS && (this.sample_flags[i] = t.readUint32()), this.flags & l.TRUN_FLAGS_CTS_OFFSET && (0 === this.version ? this.sample_composition_time_offset[i] = t.readUint32() : this.sample_composition_time_offset[i] = t.readInt32())
            ...
            if (this.hvcC) {
                ...
                e += l.decimalToHex(s, 0), e += ".", 0 === this.hvcC.general_tier_flag ? e += "L" : e += "H", e += this.hvcC.general_level_idc;
                var r = !1,
                    n = "";
                for (t = 5; t >= 0; t--)(this.hvcC.general_constraint_indicator[t] || r) && (n = "." + l.decimalToHex(this.hvcC.general_constraint_indicator[t], 0) + n, r = !0);
                e += n
            }
            return e
            ...
            this.size += 8, this.size > o && (this.size += 8), "uuid" === this.type && (this.size += 16), r.debug("BoxWriter", "Writing box " + this.type + " of size: " + this.size + " at position " + t.getPosition() + (e || "")), this.size > o ? t.writeUint32(1) : (this.sizePosition = t.getPosition(), t.writeUint32(this.size)), t.writeString(this.type, null, 4), "uuid" === this.type && t.writeUint8Array(this.uuid), this.size > o && t.writeUint64(this.size)
            ...
            var e, i, s;
            for (s = 0, e = 0; e < this.sample_counts.length; e++)
                for (i = 0; i < this.sample_counts[e]; i++) t[s].dts = 0 === s ? 0 : t[s - 1].dts + this.sample_deltas[e], s++
        ...
        }, t.XMLSubtitlein4Parser = p, t.Textin4Parser = f;
        var u = function(t) {
        ...
        u.prototype.setSegmentOptions = function(t, e, i) {
            ...
            if (!this.restoreParsePosition || this.restoreParsePosition())
                for (;;) {
                    ...
                    if (this.saveParsePosition && this.saveParsePosition(), (t = l.parseOneBox(this.stream, false)).code === l.ERR_NOT_ENOUGH_DATA) {
            ...
            if (this.moov)
                for (n.hasMoov = !0, n.duration = this.moov.mvhd.duration, n.timescale = this.moov.mvhd.timescale, n.isFragmented = null != this.moov.mvex, n.isFragmented && this.moov.mvex.mehd && (n.fragment_duration = this.moov.mvex.mehd.fragment_duration), n.isProgressive = this.isProgressive, n.hasIOD = null != this.moov.iods, n.brands = [], n.brands.push(this.ftyp.major_brand), n.brands = n.brands.concat(this.ftyp.compatible_brands), n.created = new Date(a + 1e3 * this.moov.mvhd.creation_time), n.modified = new Date(a + 1e3 * this.moov.mvhd.modification_time), n.tracks = [], n.audioTracks = [], n.videoTracks = [], n.subtitleTracks = [], n.metadataTracks = [], n.hintTracks = [], n.otherTracks = [], t = 0; t < this.moov.traks.length; t++) {
                    ...
                    i.edts && (s.edits = i.edts.elst.entries), s.created = new Date(a + 1e3 * i.tkhd.creation_time), s.modified = new Date(a + 1e3 * i.tkhd.modification_time), s.movie_duration = i.tkhd.duration, s.movie_timescale = n.timescale, s.layer = i.tkhd.layer, s.alternate_group = i.tkhd.alternate_group, s.volume = i.tkhd.volume, s.matrix = i.tkhd.matrix, s.track_width = i.tkhd.width / 65536, s.track_height = i.tkhd.height / 65536, s.timescale = i.mdia.mdhd.timescale, s.cts_shift = i.mdia.minf.stbl.cslg, s.duration = i.mdia.mdhd.duration, s.samples_duration = i.samples_duration, s.codec = r.getCodec(), s.kind = i.udta && i.udta.kinds.length ? i.udta.kinds[0] : {
                        schemeURI: "",
                        value: ""
                    }, s.language = i.mdia.elng ? i.mdia.elng.extended_language : i.mdia.mdhd.languageString, s.nb_samples = i.samples.length, s.size = i.samples_size, s.bitrate = 8 * s.size * s.timescale / s.samples_duration, r.isAudio() ? (s.type = "audio", n.audioTracks.push(s), s.audio = {}, s.audio.sample_rate = r.getSampleRate(), s.audio.channel_count = r.getChannelCount(), s.audio.sample_size = r.getSampleSize()) : r.isVideo() ? (s.type = "video", n.videoTracks.push(s), s.video = {}, s.video.width = r.getWidth(), s.video.height = r.getHeight()) : r.isSubtitle() ? (s.type = "subtitles", n.subtitleTracks.push(s)) : r.isHint() ? (s.type = "metadata", n.hintTracks.push(s)) : r.isMetadata() ? (s.type = "metadata", n.metadataTracks.push(s)) : (s.type = "metadata", n.otherTracks.push(s))
                } else n.hasMoov = !1;
                ...
                if (null !== this.onSamples)
                    for (e = 0; e < this.extractedTracks.length; e++) {
                        ...
                        for (i = a.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted;) {
                            ...
                            if (!o) break;
                            if (i.nextSample++, a.samples.push(o), (i.nextSample % a.nb_samples == 0 || i.nextSample >= i.samples.length) && (r.debug("ISOFile", "Sending samples on track #" + a.id + " for sample " + i.nextSample), this.onSamples && this.onSamples(a.id, a.user, a.samples), a.samples = [], a !== this.extractedTracks[e])) break
                        }
                    }
            }
            ...
            return a = i.samples[d].offset + i.samples[d].alreadyRead, r.info("ISOFile", "Seeking to " + (e ? "RAP" : "") + " sample #" + i.nextSample + " on track " + i.tkhd.track_id + ", time " + r.getDurationString(t, o) + " and offset: " + a), {
                offset: a,
                time: t / o
            }
        ...
        }, u.prototype.add = l.Box.prototype.add, u.prototype.addBox = l.Box.prototype.addBox, u.prototype.init = function(t) {
            var e = t || {};
            ...
            if (void 0 !== l[e.type + "SampleEntry"]) {
                ...
                for (var h in l.sampleEntryCodes)
                    ...
                    case "Visual":
                        if (r.add("vmhd").set("graphicsmode", 0).set("opcolor", [0, 0, 0]), a.set("width", e.width).set("height", e.height).set("horizresolution", 72 << 16).set("vertresolution", 72 << 16).set("frame_count", 1).set("compressorname", e.type + " Compressor").set("depth", 24), e.avcDecoderConfigRecord) {
                            var f = new l.avcCBox,
                    ...
                    case "Hint":
                        ...
                        break;
                    case "Subtitle":
                        if (r.add("sthd"), "stpp" === e.type) a.set("namespace", e.namespace || "nonamespace").set("schema_location", e.schema_location || "").set("auxiliary_mime_types", e.auxiliary_mime_types || "");
                        break;
                    default:
                        r.add("nmhd")
                }
                ...
                var c = r.add("stbl");
                return c.add("stsd").addEntry(a), c.add("stts").set("sample_counts", []).set("sample_deltas", []), c.add("stsc").set("first_chunk", []).set("samples_per_chunk", []).set("sample_description_index", []), c.add("stco").set("chunk_offsets", []), c.add("stsz").set("sample_sizes", []), this.moov.mvex.add("trex").set("track_id", e.id).set("default_sample_description_index", e.default_sample_description_index || 1).set("default_sample_duration", e.default_sample_duration || 0).set("default_sample_size", e.default_sample_size || 0).set("default_sample_flags", e.default_sample_flags || 0), this.buildTrakSampleLists(i), e.id
            }
                            ...
                            for (p = d.trafs[t], f = this.getTrackById(p.tfhd.track_id), c = this.getTrexById(p.tfhd.track_id), s = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_DESC ? p.tfhd.default_sample_description_index : c ? c.default_sample_description_index : 1, r = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_DUR ? p.tfhd.default_sample_duration : c ? c.default_sample_duration : 0, n = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_SIZE ? p.tfhd.default_sample_size : c ? c.default_sample_size : 0, a = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_FLAGS ? p.tfhd.default_sample_flags : c ? c.default_sample_flags : 0, p.sample_number = 0, p.sbgps.length > 0 && u.initSampleGroups(f, p, p.sbgps, f.mdia.minf.stbl.sgpds, p.sgpds), e = 0; e < p.truns.length; e++) {
                                ...
                                for (i = 0; i < g.sample_count; i++) {
                                    ...
                                    var y = !!(p.tfhd.flags & l.TFHD_FLAG_BASE_DATA_OFFSET),
                                        ...
                                        w = 0;
                                    w = y ? p.tfhd.base_data_offset : b || 0 === e ? d.start : o, m.offset = 0 === e && 0 === i ? v ? w + g.data_offset : w : o, o = m.offset + m.size, (p.sbgps.length > 0 || p.sgpds.length > 0 || f.mdia.minf.stbl.sbgps.length > 0 || f.mdia.minf.stbl.sgpds.length > 0) && u.setSampleGroupProperties(f, m, m.number_in_traf, p.sample_groups_info)
                                }
                            }
                            if (p.subs) {
                                f.has_fragment_subsamples = !0;
                                var S = p.first_sample_index;
                                for (e = 0; e < p.subs.entries.length; e++) S += p.subs.entries[e].sample_delta, (m = f.samples[S - 1]).subsamples = p.subs.entries[e].subsamples
                            }
                        }
        ...
        try {
            ...
            const p = new i({
                output: t => {
                    createImageBitmap(t, {
                        ...
                        e(i), t.close(), p.decodeQueueSize <= 0 && setTimeout((() => {
            ...
            d.onReady = t => {
                if (t && t.videoTracks && t.videoTracks[0]) {
                    [{
                        codec: l
                    }] = t.videoTracks, r && console.info("Video with codec:", l);
                    const e = (t => {
                        let e, i = 7;
                        for (e = 0; e < t.SPS.length; e += 1) i += 2 + t.SPS[e].length;
                        for (e = 0; e < t.PPS.length; e += 1) i += 2 + t.PPS[e].length;
                        const s = new a(i);
                        for (s.writeUint8(t.configurationVersion), s.writeUint8(t.AVCProfileIndication), s.writeUint8(t.profile_compatibility), s.writeUint8(t.AVCLevelIndication), s.writeUint8(t.lengthSizeMinusOne + 252), s.writeUint8(t.nb_SPS_nalus + 224), e = 0; e < t.SPS.length; e += 1) s.writeUint16(t.SPS[e].length), s.writeUint8Array(t.SPS[e].nalu);
                    ...
                    p.configure({
                        codec: l,
                        description: e
                    }), d.setExtractionOptions(t.videoTracks[0].id), d.start()
                ...
                return e.read().then((function t({
                    ...
                    const n = r.buffer;
                    return n.fileStart = i, i += n.byteLength, d.appendBuffer(n), e.read().then(t)
                }))
            }))
        } catch (t) {
            h(t)
    ...
    return class {
        constructor({
            ...
            this.isSafari = "WebKit" === p.name, l && this.isSafari && console.info("Safari browser detected"), this.currentTime = 0, this.targetTime = 0, this.canvas = null, this.context = null, this.frames = [], this.frameRate = 0, this.updateScrollPercentage = t => {
                ...
                this.debug && console.info("ScrollyVideo scrolled to", i), this.setTargetTimePercent(i, {
                    jump: t
                })
        ...
        setCoverStyle(t) {
            if (this.cover) {
                ...
                const {
                    width: e,
                    height: i
                } = this.container.getBoundingClientRect(), s = t.videoWidth || t.width, r = t.videoHeight || t.height;
                this.debug && console.info("Container dimensions:", [e, i]), this.debug && console.info("Element dimensions:", [s, r]), e / i > s / r ? (t.style.width = "100%", t.style.height = "auto") : (t.style.height = "100%", t.style.width = "auto")
            }
        }
        decodeVideo() {
            var t, e, i;
            this.useWebCodecs && this.src && (t = this.src, e = t => {
                this.frames.push(t)
            }, i = this.debug, "function" == typeof VideoDecoder && "function" == typeof EncodedVideoChunk ? (i && console.info("WebCodecs is natively supported, using native version..."), o(t, e, {
        ...
        transitionToTargetTime({
            ...
            const s = this.targetTime - this.currentTime,
                ...
                o = ({
                    ...
                    const l = (d - h) / n,
                        p = a ? this.currentTime >= this.targetTime : this.currentTime <= this.targetTime;
                    if (isNaN(this.targetTime) || Math.abs(this.targetTime - this.currentTime) < this.frameThreshold || p) return this.video.pause(), void(this.transitioningRaf && (cancelAnimationFrame(this.transitioningRaf), this.transitioningRaf = null));
                    ...
                    if (this.canvas) t ? this.currentTime = this.targetTime : u ? this.currentTime = c : this.currentTime += f / (256 / e), this.paintCanvasFrame(Math.floor(this.currentTime * this.frameRate));
                    else if (t || this.isSafari || !a) this.video.pause(), u ? this.currentTime = c : this.currentTime += f / (64 / e), t && (this.currentTime = this.targetTime), this.video.currentTime = this.currentTime;
                    else {
                    ...
                    "function" == typeof requestAnimationFrame && (this.transitioningRaf = requestAnimationFrame((t => o({
                        startCurrentTime: s,
                        startTimestamp: h,
                        timestamp: t
                    }))))
                };
            "function" == typeof requestAnimationFrame && (this.transitioningRaf = requestAnimationFrame((t => {
                o({
        ...
        setTargetTimePercent(t, e = {}) {
            this.targetTime = Math.max(Math.min(t, 1), 0) * (this.frames.length && this.frameRate ? this.frames.length / this.frameRate : this.video.duration), !e.jump && Math.abs(this.currentTime - this.targetTime) < this.frameThreshold || (this.canvas || this.video.paused || this.video.play(), this.transitionToTargetTime(e))
        }
        setScrollPercent(t) {
            if (!this.trackScroll) return void console.warn("`setScrollPercent` requires enabled `trackScroll`");
